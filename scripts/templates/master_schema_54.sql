...
CREATE TABLE `attrib_type` (
  ...
  UNIQUE KEY `c` (`code`)
) ENGINE=MyISAM AUTO_INCREMENT=11168 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=5938261 DEFAULT CHARSET=latin1;
...
CREATE TABLE `object_xref` (
  ...
  KEY `analysis_idx` (`analysis_id`)
) ENGINE=MyISAM AUTO_INCREMENT=859843 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=875164 DEFAULT CHARSET=latin1;
